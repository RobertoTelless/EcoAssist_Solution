...
namespace ERP_CRM_Solution.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public ActionResult MontarTelaUsuario()
        {
            ...
            // Carrega listas
            if ((List<USUARIO_SUGESTAO>)Session["ListaUsuario"] == null)
            {
                listaMaster = baseApp.GetAllItens();
                Session["ListaUsuario"] = listaMaster;
                Session["FiltroUsuario"] = null;
            }
            List<USUARIO_SUGESTAO> listaUsu = (List<USUARIO_SUGESTAO>)Session["ListaUsuario"];
        ...
        [HttpPost]
        public ActionResult FiltrarUsuario(USUARIO_SUGESTAO item)
        {
            try
            {
                // Executa a operação
                ...
                Int32 idAss = (Int32)Session["IdAssinante"];
                List<USUARIO_SUGESTAO> listaObj = new List<USUARIO_SUGESTAO>();
        ...
        public ActionResult MostrarTudoUsuario()
        {
            ...
            listaMaster = baseApp.GetAllUsuarios();
            Session["ListaUsuario"] = listaMaster;
            return RedirectToAction("MontarTelaUsuario");
        }
        ...
        public ActionResult VerUsuario(Int32 id)
        {
            ...
            USUARIO_SUGESTAO item = baseApp.GetItemById(id);
        ...
        public ActionResult IncluirUsuario()
        {
            ...
            // Prepara listas
            ViewBag.Perfis = new SelectList((List<PERFIL>)Session["Perfis"], "PERF_CD_ID", "PERF_NM_NOME");
            ViewBag.Cargos = new SelectList(baseApp.GetAllCargos().OrderBy(p => p.CARG_NM_NOME), "CARG_CD_ID", "CARG_NM_NOME");
            ViewBag.Deptos = new SelectList(depApp.GetAllItens().OrderBy(x => x.DEPT_NM_NOME).ToList<DEPARTAMENTO>(), "DEPT_CD_ID", "DEPT_NM_NOME");
        ...
        public ActionResult IncluirUsuario(UsuarioViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    // Executa a operação
                    USUARIO_SUGESTAO item = Mapper.Map<UsuarioViewModel, USUARIO_SUGESTAO>(vm);
                    ...
                    // Cria pastas
                    String caminho = "/Imagens/1" + "/Usuario/" + item.USUA_CD_ID.ToString() + "/Fotos/";
                    Directory.CreateDirectory(Server.MapPath(caminho));
                    caminho = "/Imagens/1" + "/Usuario/" + item.USUA_CD_ID.ToString() + "/Anexos/";
                    Directory.CreateDirectory(Server.MapPath(caminho));

                    // Sucesso
                    listaMaster = new List<USUARIO_SUGESTAO>();
                    Session["ListaUsuario"] = null;
       ...
       [HttpGet]
        public ActionResult BloquearUsuario(Int32 id)
        {
            ...
            // Executar
            USUARIO_SUGESTAO item = baseApp.GetItemById(id);
            objetoAntes = (USUARIO_SUGESTAO)Session["Usuario"];

            USUARIO_SUGESTAO block = new USUARIO_SUGESTAO();
            ...
            {
                FiltrarUsuario((USUARIO_SUGESTAO)Session["FiltroUsuario"]);
            }
            return RedirectToAction("MontarTelaUsuario");
        }
        ...
        public ActionResult DesbloquearUsuario(Int32 id)
        {
            ...
            USUARIO_SUGESTAO unblock = new USUARIO_SUGESTAO();
        ...
        public ActionResult DesativarUsuario(Int32 id)
        {
            ...
            USUARIO_SUGESTAO dis = new USUARIO_SUGESTAO();
        ...
        public ActionResult ReativarUsuario(Int32 id)
        {
            ...
            USUARIO_SUGESTAO en = new USUARIO_SUGESTAO();
        ...
        public ActionResult UploadFileQueueUsuario(FileQueue file)
        {
            ...
            USUARIO_SUGESTAO item = baseApp.GetById(idNot);
            ...
            String caminho = "/Imagens/1" + "/Usuario/" + item.USUA_CD_ID.ToString() + "/Anexos/";
       ...
       [HttpPost]
        ...
        public ActionResult UploadFotoQueueUsuario(FileQueue file)
        {
            ...
            USUARIO_SUGESTAO item = baseApp.GetById(idUsu);
            USUARIO_SUGESTAO usu = (USUARIO_SUGESTAO)Session["UserCredentials"];
            var fileName = file.Name;
            if (fileName.Length > 250)
            {
        ...
        {            
            ...
            List<USUARIO_SUGESTAO> lista = (List<USUARIO_SUGESTAO>)Session["ListaUsuario"];
            USUARIO_SUGESTAO filtro = (USUARIO_SUGESTAO)Session["FiltroUsuario"];
            ...
            foreach (USUARIO_SUGESTAO item in lista)
            {
        ...
        {            
            // Prepara geração
            USUARIO_SUGESTAO aten = baseApp.GetItemById((Int32)Session["IdUsuario"]);
            String data = DateTime.Today.Date.ToShortDateString();
            data = data.Substring(0, 2) + data.Substring(3, 2) + data.Substring(6, 4);
        ...
        public ActionResult MontarTelaDashboardAdministracao()
        {
            ...
            List<USUARIO_SUGESTAO> listaTotal = baseApp.GetAllItens();
            List<USUARIO_SUGESTAO> bloqueados = listaTotal.Where(p => p.USUA_IN_BLOQUEADO == 1).ToList();
            ...
            // Recupera listas log
            List<LOG> listaLog = logApp.GetAllItens();
