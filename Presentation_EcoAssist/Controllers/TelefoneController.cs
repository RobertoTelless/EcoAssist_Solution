...
namespace ERP_CRM_Solution.Controllers
{
    public class TelefoneController : Controller
    {
        ...
        public ActionResult MontarTelaTelefone()
        {
            ...
            ViewBag.Cats = new SelectList(cfApp.GetAllItens().OrderBy(x => x.CATE_NM_NOME), "CATE_CD_ID", "CATE_NM_NOME");
        ...
        public ActionResult FiltrarTelefone(TELEFONE item)
        {
            ...
            try
            {
                ...
                Int32 volta = fornApp.ExecuteFilter(item.CATE_CD_ID, item.TELE_NM_NOME, item.TELE_NR_TELEFONE, item.TELE_NM_CIDADE, item.UF_CD_ID, item.TELE_NR_CELULAR, item.TELE_NM_EMAIL, out listaObj);
        ...
        public ActionResult IncluirTelefone(TelefoneViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    Session["Telefones"] = fornApp.GetAllItens();
