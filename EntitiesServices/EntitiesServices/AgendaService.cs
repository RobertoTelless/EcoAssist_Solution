...
namespace ModelServices.EntitiesServices
{
    public class AgendaService : ServiceBase<AGENDA>, IAgendaService
    {
        ...
        public List<AGENDA> ExecuteFilter(DateTime? data, Int32? cat, String titulo, String descricao, Int32 idUser, Int32 corp)
        {
            List<AGENDA> lista = _baseRepository.ExecuteFilter(data, cat, titulo, descricao, idUser, corp);
            return lista;
        }
