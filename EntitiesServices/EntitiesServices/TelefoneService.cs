...
namespace ModelServices.EntitiesServices
{
    public class TelefoneService : ServiceBase<TELEFONE>, ITelefoneService
    {
        ...
        {
            TELEFONE item = _baseRepository.CheckExist(conta);
            return item;
        }
        ...
        public List<TELEFONE> ExecuteFilter(Int32? catId, String nome, String telefone, String cidade, Int32? uf, String celular, String email)
        {
            return _baseRepository.ExecuteFilter(catId, nome, telefone, cidade, uf, celular, email);
